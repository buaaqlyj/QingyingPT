...
//	private String mLastUpdateTime;
	 ...
	 * disable footer
	 */
	private boolean if_header_disabled = false;
	private boolean if_footer_disabled = false;
	...
	private void addHeaderView() {
		...
		mHeaderImageView.setImageResource(R.drawable.loading);
		animationLoading = (AnimationDrawable) mHeaderImageView.getDrawable();
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			int deltaY = y - mLastMotionY;
			if ((mPullState == PULL_DOWN_STATE)&&(!if_header_disabled)) {
				// PullToRefreshView执行下拉
				//Log.i(TAG, " pull down!parent view move!");
				headerPrepareToRefresh(deltaY);
				// setHeaderPadding(-mHeaderViewHeight);
			} else if ((mPullState == PULL_UP_STATE)&&(!if_footer_disabled)) {
...
//	}
	...
	public void deleteHeader(){
		if_header_disabled = true;
	}
	
	public void deleteFooter(){
		if_footer_disabled = true;
	}
